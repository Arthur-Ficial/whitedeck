...
server.registerTool(
  ...
  {
    description:
      'List the 12 Keynote White slide layouts whitedeck supports, with their markdown directive ids.',
    inputSchema: {},
  },
...
server.registerTool(
  ...
  {
    description:
      'Render whitedeck markdown into presentation files that look exactly like Apple Keynote White theme. Formats: html, pdf, pptx (editable), key (native Keynote, macOS only).',
    inputSchema: {
